...
*-- Para adaptar as pastas na versão de desenvolvimento
IF VERSION(2) = 0
	SET STATUS BAR OFF
...
_SCREEN.Caption     = "Aprovações de Notas de Compra"
_SCREEN.Icon        = "logo_somelsd.ico"
_SCREEN.WindowState = 2
_SCREEN.Visible     = .T.

*-- As informações do usuário logado ficarão visíveis em todo o sistema
...
*-- Carrega o menu principal e após o login permite o acesso aos módulos
DO mnuprincipal.mpr
IF Login()
...
*-- Deixa o ambiente "aberto" na versão de desenvolvimento
IF VERSION(2) = 0
	CLOSE DATABASES
	SET PROCEDURE TO
	SET LIBRARY TO
